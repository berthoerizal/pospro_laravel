                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="judul" id="judul" placeholder="Judul" value="{{$berita->judul}}" required>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="isi">Isi Berita</label>
                                <textarea name="isi" id="isi" class="form-control" cols="30" rows="10">{{$berita->isi}}</textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                <img src="{{ asset('assets/images/'.$berita->gambar) }}" alt="" class="img-thumbnail img-preview">
                                </div>
                                <div class="col-sm-10">
